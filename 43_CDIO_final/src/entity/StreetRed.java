...
public class StreetRed extends Street {
	...
	public StreetRed(int id, String name, int price, int rent, BoardManagement bm, String type, int house1, int house2, int house3, int house4, int hotel1, int housePrice) {

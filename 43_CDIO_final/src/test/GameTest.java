	...
	public static void main(String[] args) throws Exception{
		...
		while(gameOn){
			for(int i = 0; i < pM.getPlayerArray().length; i++){
				...
				if (bM.getSquare(pM.getPlayer(i).getPosition()).getClass() == (bM.getOwnableSquare(pM.getPlayer(i).getPosition()).getClass())) { //Is the field an Ownable square?
					
					System.out.println(bM.getSquare(pM.getPlayer(i).getPosition()).getClass() + " is equal to " + bM.getOwnableSquare(pM.getPlayer(i).getPosition()).getClass());
				...
				else if (bM.getSquare(pM.getPlayer(i).getPosition()).getClass() == (bM.getOwnableSquare(pM.getPlayer(i).getPosition()).getClass())) { //Is the field a chance square?
